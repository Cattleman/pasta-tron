 ...
 * takes csv of path to image and label,
 * Loads the image and preforms augmentation
 * Prep and load data for training or eval
"""


# TODOs
# Take the params out of here and put them into a json file
# consider seperating the data augmentation and the data loading for the model as as
# seperate processes?
